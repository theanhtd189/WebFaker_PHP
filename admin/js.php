...
<div class="card-body">
    <h4 class="card-title"><i class="mdi mdi-bullseye"></i> Web Javascript </h4>
    <p class="card-description">Ghi đè, thêm mới js cho web </p>
    ...
    <blockquote class="blockquote" style="position: relative;display:none" id="_table">
        <div class="card-body">
            <form class="forms-sample" enctype="multipart/form-data" autocomplete="off" id="post_form">
                ...
                <div class="form-group">
                    <label for="">JS <code>( Nội dung JS )</code> </label>
